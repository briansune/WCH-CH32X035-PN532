...
//IO方向设置
#define SCL_IN()  {GPIOB->CFGHR&=0XFFFFF0FF;GPIOB->CFGHR|=8<<8;}
#define SCL_OUT() {GPIOB->CFGHR&=0XFFFFF0FF;GPIOB->CFGHR|=3<<8;}
...
#define READ_SCL         GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_10)
